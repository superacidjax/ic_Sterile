...
(function($) {
	...
	$.fn.royalSlider.defaults = {    
			...
			slideTransitionType: "fade",			// "fade" or "move"
			slideTransitionSpeed:200,               // Slide transition speed in ms (1000ms = 1s)
			...
			captionShowSpeed:1000,                   // Default caption show speed in ms
			captionShowEasing:"easeOutCubic",       // Default caption show easing
			captionShowDelay:900,                   // Default delay between captions on one slide show
			...
			slideshowDelay:7500,                    // Delay between slides in slideshow
